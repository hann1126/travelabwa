            ...
            <div class="bg-white p-4 rounded-[26px] flex flex-col gap-3">
              ...
              <div class="flex justify-between items-center">
                ...
                <p class="text-sm leading-[22px] tracking-035">
                  <span class="font-semibold text-[#4D73FF] text-nowrap">Rp {{ number_format($tour->price, 0, ',','.') }}/span><span class="text-darkGrey">/{{$tour->day}}days</span>
                </p>
              </div>
            </div>
          </a>
          @empty
          <p>Belum ada paket tour pada categori ini</p>
          @endforelse
