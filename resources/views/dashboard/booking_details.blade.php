            ...
            <div class="bg-white p-4 rounded-[26px] flex items-center gap-3">
              ...
              <div class="flex flex-col gap-1">
                ...
                <div class="flex gap-1 items-center">
                  ...
                  <span class="text-darkGrey text-sm tracking-035 leading-[22px]">{{ \Carbon\Carbon::parse($packageBooking->start_date)->format('M d, Y') }} - {{ \Carbon\Carbon::parse($packageBooking->end_date)->format('M d, Y') }}</span>
                </div>
          ...
          <div class="flex flex-col gap-3 px-4 ">
            ...
            <div class="bg-white p-[16px_24px] rounded-[26px] flex flex-col gap-3">
              ...
              <div class="flex justify-between items-center text-sm tracking-035 leading-[22px]">
                ...
                <p id="insurance" class="font-semibold text-blue">Rp 600.000{{number_format($packageBooking->insurance, 0,',','.')}}</p>
              </div>
              <div class="flex justify-between items-center text-sm tracking-035 leading-[22px]">
                <p>Tax 10%</p>
              ...
              <div class="flex justify-between items-center text-sm tracking-035 leading-[22px] h-[55px]">
                <p>Total Payment</p>
                <p id="tax" class="font-semibold text-lg tracking-[0.6px]">Rp 2.580.000{{number_format($packageBooking->total_amount, 0,',','.')}}</p>
              </div>
            </div>
          </div>
          <div class="flex flex-col gap-3 px-4 ">
